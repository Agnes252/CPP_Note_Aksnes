/*
    ...
    2025.3.15 Amplified with Distance outputs.
        ...
        A const point created. Getter functions are turned into const functions.
...
int main()
{
    ...
    const Point cp(0, 3);	//cp.X(0.3); // Result in compiler error.
	cout << "X coordinate of a const point: " << cp.X() << endl;

    return 0;
    /*
    Conclusion:
        To get coordinates of a const object,
            getter functions need to be turned into const functions.
    */
}