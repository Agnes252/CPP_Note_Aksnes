...
int main()
{
    ...
    while (ASCII_input_character != 4);

    num_characters--; // delete the last count of character

	if (flg_last_new_line) // delete the last count of new line
	{
		num_newlines--;
	}
