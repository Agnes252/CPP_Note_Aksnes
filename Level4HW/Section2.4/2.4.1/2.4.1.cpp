/*
    ...
    Test member operator overloading: chain assignment. 
...
int main()
{
    ...
    p3 *= factor;
    cout << "p3 *= factor, then p3 =" << p3.ToString() << endl << endl;
    ...
    cout << "line1 = line2 = line3, then line1 =" << line1.ToString() << endl 
        << "line2=" << line2.ToString() << endl << "line3=" << line3.ToString() << endl << endl;
    ...
    << "c2=" << c2.ToString() << endl << "c3=" << c3.ToString() << endl << endl;
